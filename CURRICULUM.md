...
**Odgovorni profesor:** Milosav Milosavljević

### I Nastavni program
1. **Osnovni pojmovi iz socijalne politike**
   - Pojam politike
   - Pojam socijalnog
   - Različita shvatanja pojma socijalna politika
   - Socijalni razvoj
   - Socijalna sigurnost
   - Socijalne potrebe
   - Socijalni slučaj
...
6. **Modeli i koncepcije socijalne politike**
   - Neoliberalistički model socijalne politike
   - Socijalnodemokratski modeli socijalne politike
   - Korporativistički model
   - Socijalno-politički model ugovorne države blagostanja
   - Model integrisane socijalne i ekonomske politike
   - Socijalna politika bivših socijalističkih država - socijalna politika u tranziciji
   - Socijalni problemi i politika zemalja u razvoju
...
8. **Socijalni problemi - predmet socijalne politike**
   ...
   - Depopulacija i "demografska eksplozija"
   - Manjinske i marginalizovane skupine
   - Diskriminacija i rasizam
   - Socijalne bolesti
   - Društvene devijacije

9. **Sadržaji i područja socijalne politike**
   - Socijalna sigurnost po osnovu rada
   - Zdravstvena zaštita i zdravstveno osiguranje
   - Zapošljavanje i socijalna sigurnost za slučaj nezaposlenosti
   - Društvena zaštita porodice i djece: dječija zaštita
   - Penzijsko i invalidsko osiguranje
   - Socijalna zaštita
   - Zaštita bivših boraca, vojnih i civilnih invalida rata
   - Socijalno-politički aspekti obrazovanja
   - Socijalno-politički aspekti stambene politike
   - Dobrovoljno osiguranje života i imovine
   - Komunalne i uslužne djelatnosti

### Literatura
1. Milosavljević, M. (redaktor) i ostali: *Socijalna politika u tranziciji*, Centar za proučavanje alternativa i "Socijalna misao", Zagreb
2. Lakićević, D.: *Socijalna politika*, "Savremena administracija", Beograd, 1998.
3. Milosavljević, M.: *Socijalni rad na međi vijekova*, "Draganić", Zagreb, 1998.
4. Milosavljević, M.: *Socijalna sigurnost u samoupravnom društvu*, Zavod za udžbenike i nastavna sredstva, Beograd
5. Nedović, S.: *Država blagostanja*, "Draganić", Beograd, 1998.

---

## 2. Teorije socijalnog rada
**Semestar:** IV
**Status:** Obavezan predmet
**Fond:** 60 časova nastave
...
2. Milosav Milosavljević (1998): *Socijalni rad na međi vekova*, Beograd, Draganić
3. David Howe (1997): *Uvod u teoriju socijalnog rada*, Beograd, Naučno-istraživački centar za socijalni rad i socijalnu politiku FPN
4. Grupa autora (2005): *Održivi razvoj i socijalni rad*, Banja Luka, Univerzitet u Banjoj Luci, Filozofski fakultet
5. Milosav Milosavljević i Miroslav Brkić (2005): *Socijalni rad u zajednici*, Beograd, Socijalna misao
6. Milan Petričković (2006): *Teorije socijalnog rada*, Beograd, Socijalna misao
...
2. Miroslav Pečujlić, Vladimir Milić: *Sociologija*, Zavod za udžbenike, Beograd, 1991.

---

## 4. Filozofija sa etikom
**Profesor:** Doc. Dr Ostoja Đukić
**Semestar:** I i II (2+1)
...
## 5. Pedagogija
**Predavač:** Prof. dr Drago Branković
...
2. Pojmovno-terminološki sistem
3. Pedagogija i druge nauke
4. Ličnost kao centar vaspitanja
5. Cilj i zadaci vaspitanja
6. Osnovni činioci vaspitanja
7. Osnovne koncepcije vaspitanja
8. Vaspitanik kao subjekt i objekt
9. Vaspitač - ličnost i funkcije
10. Vaspitno-obrazovni sistem kod nas
11. Pedagogija, antipedagogija i alternativno obrazovanje
12. Savremeni tokovi u pedagogiji
13. Teorijsko-metodološke osnove vaspitnog procesa
14. Pedagoške naučne činjenice
15. Vaspitno-obrazovne zakonitosti
16. Pedagoške naučne teorije
17. Teorije intelektualnog vaspitanja
18. Teorije moralnog vaspitanja
19. Teorije estetskog vaspitanja
...
## 6. Socijalno pravo s osnovama prava
**Godina:** I
**Semestar:** I i II
**Fond:** 2+1 časova sedmično
**Status:** Obavezan
...
### Literatura
**Obavezna:**
1. Željko Mirjanić, Snežana Savić: *Socijalno pravo s osnovama prava*, Filozofski fakultet Banja Luka, 2003.
2. Pozitivnopravni propisi koji čine socijalno pravo.
3. Relevantni međunarodni akti.

---

## 7. Ljudska prava i slobode
**Odgovorni profesor:** Mile Dmičić
**Semestar:** I (2+1)
...
### Literatura
**Osnovna:**
1. V. Dimitrijević, M. Paunović: *Ljudska prava*, Beograd, 1997.
2. N. Vučinić: *Osnovi ljudskih prava i sloboda*, Podgorica, 2001.
...
- **Čitanje:** Kraći književni tekstovi, novinski članci.
- **Pisanje:** Eseji, pisma, biografije.
- **Video:** Gledanje odlomaka i vježbe.

### Literatura
1. Adrian Doff, Jones Christopher: *Language in Use* (Pre-Intermediate).
2. Cunningham, Sarah, Peter Moor: *Cutting Edge* (Pre-Intermediate).
3. Popović, Mirić: *Gramatika engleskog jezika sa vježbanjima*.
...
**Program I godina:**
- Fonetika, Izgovor.
- Morfologija (članovi, imenice, pridjevi, zamjenice).
- Glagoli i glagolska vremena (prezent, futur, prošlo).
- Knjiga: *Un tuffo nell'azzurro*.

**Program II godina:**
- Gramatika, Konverzacija, Pisanje (biografije, pisma), Čitanje novina, Filmovi.

---

## 10. Njemački jezik (Opšti kurs)
**Trajanje:** 4 semestra
**Ciljevi:**
- Usmeno i pismeno izražavanje, razumijevanje, gramatika, leksika, kultura.

### Literatura
1. Schulz, Griesbach: *Deutsche Sprachlehre für Ausländer*, Grundstufe 1 & 2, Max Hueber Verlag.
...
3. **Windows:** Osnovni pojmovi, rad s datotekama.
4. **MS Word:** Obrada teksta, formatiranje.
5. **MS Excel:** Tabelarni proračuni, grafikoni.
6. **Internet:** Web, E-mail, Internet Explorer.
7. **Power Point:** Izrada prezentacija.
...
**Termin:** Proljećni semestar (Spring 2003 - arhivski podatak)
**Predavači:** Agneta Kindborg, Bodil Eriksson, Kristina Urbanc, Tamara Pribišev Beleslin, Olivera Mastikosa.

### Ciljevi (Objectives)
Razvijanje socijalne perspektive o invalidnosti:
- Razumijevanje socijalne inkluzije/ekskluzije.
- Socijalni model naspram individualnog modela.
- Uslovi života, podrška, servisi.
- Osnaživanje (empowerment), zastupanje (advocacy).
- Socijalni i psihološki aspekti.

### Teme (Content)
- Istorijske perspektive.
- Socijalni model invalidnosti.
- Životni ciklus i konstruktivistička perspektiva (Foucault).
- Učenje i intelektualne teškoće.
- Pravni okviri i konvencije.
- Gender perspektiva i invalidnost.
- Intervju sa osobom sa invaliditetom (praktični zadatak).
...
### Sadržaj
1. Područje proučavanja i razvoj socijalne psihologije.
2. **Socijalizacija:** Pojam, faktori, procesi, efekti na saznajne procese i emocije.
3. Socijalna percepcija i atribucija.
4. **Socijalni stavovi:** Nastanak, mijenjanje.
5. **Socijalne predrasude:** Stereotipije, diskriminacija.
6. **Socijalna interakcija:** Komunikacija, privlačnost.
7. **Socijalne grupe:** Pojam, vrste (strukturisane, nestrukturisane - masa, publika).
8. **Vođstvo:** Teorije, stilovi.
9. **Grupno odlučivanje.**
10. **Socijalni konflikti:** Vrste, rješavanje (nenasilno).
11. Interakcija između polova.
...
### Ciljevi i sadržaj
Upoznavanje sa teorijama psihologije grupa i metodama rada sa grupama.
- Grupna analitička teorija.
- Vođenje grupa.
- Vrste grupnih aktivnosti.
- Rad sa grupama djece, adolescenata, odraslih, zavisnika.
- Posmatranje grupa - metodologija.

### Literatura
1. Payne, M.: *Modern Social Work Theory*.
2. Lindstein, T.: *Group-analytic Theory*; *Working with children of Alcoholics*.
3. Ajduković, M.: *Grupni pristup u psihosocijalnom radu*.

---

## 20. Metodologija društvenih istraživanja
...
## 21. Radno pravo sa sociologijom rada
...
## 22. Organizacija socijalnog rada i menadžment
**Fond:** 3+1
**Status:** Obavezan
...
2. Katlip, Senter, Brum: *Uspešni odnosi sa javnošću*.

---

## 23. Mentalna higijena
**Profesor:** Prof. dr Ivan Vidanović
**Semestar:** V (2+2)
**Status:** Izborni
...
2. Vlajković, J.: *Teorija i praksa mentalne higijene*.

---


## 24. Socijalna medicina
**Profesor:** Prof. dr Dejan Šumrak
**Godina:** IV
...
2. Singer, Mikšaj-Todorović: *Delinkvencija mladih*.
